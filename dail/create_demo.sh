...
python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_dynamics_corner.npz --edomain reacher2_dynamics_corner --ldomain reacher2_dynamics_corner --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0
python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_dynamics_wall.npz --edomain reacher2_dynamics_wall --ldomain reacher2_dynamics_wall --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0

python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_viewpoint_corner.npz --edomain reacher2_viewpoint_corner --ldomain reacher2_viewpoint_corner --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0
python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_viewpoint_wall.npz --edomain reacher2_viewpoint_wall --ldomain reacher2_viewpoint_wall --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0

python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_little_slow_corner.npz --edomain reacher2_little_slow_corner --ldomain reacher2_little_slow_corner --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0
python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_little_slow_wall.npz --edomain reacher2_little_slow_wall --ldomain reacher2_little_slow_wall --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0

python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_little_fast_corner.npz --edomain reacher2_little_fast_corner --ldomain reacher2_little_fast_corner --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0
python train.py --load_expert_dir None --save_dataset_dir expert_data/demo/0207/reacher2_little_fast_wall.npz --edomain reacher2_little_fast_wall --ldomain reacher2_little_fast_wall --gpu 5 --agent_type create_demo --algo ddpg --n_demo 2000 --seed 0
