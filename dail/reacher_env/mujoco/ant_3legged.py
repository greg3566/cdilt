...
class Ant3leggedForwardOriginalPenaltyEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.max_steps = 1000
        self.steps = 0
        ...
        self.diverge_penalty_ratio = 1.0

        print("START Forward original Ant")
        mujoco_env.MujocoEnv.__init__(self, "ant_3legged.xml", 5)
...
class Ant3leggedForwardUpdatedPenaltyEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.max_steps = 1000
        self.steps = 0
...
class Ant3leggedDiagonalOriginalPenaltyEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.max_steps = 1000
        self.steps = 0
...
class Ant3leggedDiagonalUpdatedPenaltyEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.max_steps = 1000
        self.steps = 0
