...
PYTHON_CMD="source ${VENV_DIR} && python train.py --algo ddpg --agent_type zeroshot --load_expert_dir ./target_expert/reacher3_push/alldemo --load_learner_dir ./saved_alignments/embodiment/12goals/ta/seed_${i} --edomain reacher3_push --ldomain reacher2_push --seed 100${i} --doc e_r2p"
