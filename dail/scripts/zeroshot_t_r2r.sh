...
PYTHON_CMD="source ${VENV_DIR} && python train.py --algo ddpg --agent_type zeroshot --load_expert_dir ./target_expert/reacher2_corner/alldemo --load_learner_dir ./saved_alignments/timestep/12goals/tsa/seed_${i} --edomain reacher2_corner --ldomain reacher2_slow_corner --seed 100${i} --doc t_r2r"
