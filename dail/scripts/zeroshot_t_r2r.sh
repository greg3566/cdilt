...
PYTHON_CMD="source activate ${VENV_DIR} && python train.py --algo ddpg --agent_type zeroshot --load_expert_dir None --load_learner_dir ./saved_alignments/SR2R_p_20_5/seed_${i} --edomain reacher2_slow_corner --ldomain reacher2_corner --seed 100${i} --doc t_r2r"
